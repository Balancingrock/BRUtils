...
// Default implementation. This eases the adoption of the caching mechanism for those clients that do not need the "limit by size" strategy.
...
public protocol KeyedCache {
    ...
    /// The element to be storeed in the cache
...
public enum PurgeStrategy {
    ...
    /// Set the purge strategy to this if the least used element should be removed to make place for new elements.
    
    case leastUsed
    
    
    /// Set the purge strategy to this if the least recently used element should be removed to make place for new elements.
